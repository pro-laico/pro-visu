...
On an interactive terminal, a live tracker shows per-asset progress. Press **Esc** or
**Ctrl+C** to cancel gracefully (in-flight work finishes, then the server/browser are torn
down); press again to force-quit.
