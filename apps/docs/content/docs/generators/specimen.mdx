...
| `chars` | `number` (≥0) | Fraction of cells whose glyph changes during the beat (`1` = every cell once; above `1` repeats cells). Default `0`. |
| `colors` | `number` (≥0) | Fraction of cells whose colour changes during the beat (`1` = every cell once; above `1` repeats cells). Default `0`. |
