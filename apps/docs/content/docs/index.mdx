...
More: [Getting started](/docs/getting-started) · [Configuration](/docs/configuration).

> Managed Chromium + ffmpeg, downloaded once and shared across projects — no global installs.
