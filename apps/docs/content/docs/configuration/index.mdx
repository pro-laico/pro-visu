...
export const films = [
  { name: "home", generator: "scroll-reel", options: { motion: { autoSections: { durationMs: 14000 } } } },
...
`satisfies` keeps full type-checking and autocomplete without widening the value's type.
