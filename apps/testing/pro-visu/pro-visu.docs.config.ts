  ...
  assets: [
    ...
    },
    {
      ...
      options: {
        ...
        cursor: { color: CURSOR },
        page: { waitForSelector: ".hero-media img" },
        setup: [{ do: "move", selector: ".wordmark", durationMs: 0 }],
        actions: [
          { do: "click", selector: ".nav-inline a:nth-child(1)", durationMs: 600 },
          { do: "wait", durationMs: 1300 },
          { do: "scrollTo", to: "#edit", durationMs: 1000 },
          { do: "wait", durationMs: 700 },
          { do: "click", selector: ".edit-thumb:nth-child(2)", durationMs: 550 },
          { do: "wait", durationMs: 900 },
          { do: "click", selector: ".edit-thumb:nth-child(3)", durationMs: 550 },
          { do: "wait", durationMs: 900 },
          { do: "click", selector: ".edit-thumb:nth-child(4)", durationMs: 550 },
          { do: "wait", durationMs: 1000 },
          { do: "click", selector: ".nav-inline a:nth-child(3)", durationMs: 700 },
          { do: "wait", durationMs: 1500 },
          { do: "wait", durationMs: 900 },
          { do: "click", selector: ".wordmark", durationMs: 700 },
          { do: "wait", durationMs: 400 },
          { do: "scrollTo", to: 0, durationMs: 0 },
    ...
    },
    {
      ...
      options: {
        ...
        focus: {
          ...
          padding: 24,
          actions: [
            { do: "click", selector: ".size-options button:nth-of-type(2)", durationMs: 420 },
            { do: "wait", durationMs: 600 },
            { do: "click", selector: ".size-options button:nth-of-type(3)", durationMs: 420 },
            { do: "wait", durationMs: 600 },
            { do: "click", selector: ".size-options button:nth-of-type(4)", durationMs: 420 },
            { do: "wait", durationMs: 600 },
            { do: "click", selector: ".size-options button:nth-of-type(5)", durationMs: 420 },
            { do: "wait", durationMs: 600 },
            { do: "click", selector: ".size-options button:nth-of-type(1)", durationMs: 560 },
            { do: "wait", durationMs: 900 },
    ...
    },
    {
      ...
      options: {
        ...
        setup: [{ do: "move", x: 0.16, y: 0.87, durationMs: 0 }],
        focus: {
          selector: "#feature-card",
          padding: 26,
          actions: [
            { do: "hover", selector: "#feature-card .product-media", durationMs: 600 },
            { do: "wait", durationMs: 900 },
            { do: "click", selector: "#feature-card .wishlist", durationMs: 450 },
            { do: "wait", durationMs: 1000 },
            { do: "click", selector: "#feature-card .quick-add", durationMs: 500 },
            { do: "wait", durationMs: 1300 },
            { do: "click", selector: "#feature-card .wishlist", durationMs: 450 },
            { do: "wait", durationMs: 700 },
            { do: "move", x: 0.16, y: 0.87, durationMs: 600 },
    ...
    },
    {
      ...
      options: {
        ...
        actions: [
          ...
          { do: "hover", selector: "#shop-grid .product:first-child .product-media", durationMs: 550 },
          { do: "wait", durationMs: 1000 },
          { do: "erase", selector: "#search-input", delayMs: 80, easing: "ease-in" },
          { do: "wait", durationMs: 300 },
          { do: "type", selector: "#search-input", text: "knitwear", delayMs: 55 },
          { do: "wait", durationMs: 300 },
          { do: "press", key: "Enter" },
          { do: "wait", durationMs: 800 },
          { do: "hover", selector: "#shop-grid .product:first-child .product-media", durationMs: 550 },
          { do: "wait", durationMs: 1000 },
          { do: "hover", selector: "#shop-grid .product:nth-child(2) .product-media", durationMs: 550 },
          { do: "wait", durationMs: 1000 },
          { do: "click", selector: "#shop-grid .product:nth-child(2) .product-link", durationMs: 500 },
          { do: "wait", durationMs: 2000 },
          { do: "click", selector: ".nav-inline a:nth-child(1)", durationMs: 700 },
          { do: "wait", durationMs: 900 },
          { do: "scrollTo", to: "#search-input", align: "top", offset: 40, durationMs: 800 },
          { do: "wait", durationMs: 500 },
          { do: "move", selector: "#search-input", durationMs: 600 },
          { do: "wait", durationMs: 1000 },
        ],
      },
    },
