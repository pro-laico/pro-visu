...
export const clips: AssetSpecInput[] = [
  {
    ...
    options: {
      ...
      actions: [
        { do: "click", selector: "#menu-button", durationMs: 0 },
  ...
  },
  {
    ...
    options: {
      ...
      actions: [
        { do: "hover", selector: "#shop-grid .product:nth-child(1) .product-media", durationMs: 0 },
        { do: "wait", durationMs: 2000 },
        { do: "click", selector: "#shop-grid .product:nth-child(1) .wishlist", durationMs: 0 },
  ...
  },
  {
    ...
    options: {
      ...
      actions: [
        { do: "hover", selector: "#pdp-add", durationMs: 0 },
        { do: "wait", durationMs: 3000 },
        { do: "click", selector: "#pdp-add", durationMs: 0 },
        { do: "wait", durationMs: 4500 },
        { do: "click", selector: "#cart-drawer .drawer-close", durationMs: 0 },
        { do: "wait", durationMs: 2500 },
      ],
    },
  },
  {
  ...
  },
  {
    ...
    options: {
      ...
      actions: [
        { do: "hover", selector: ".size-options", durationMs: 0 },
        { do: "wait", durationMs: 5400 },
        { do: "click", selector: ".size-options button:nth-of-type(4)", durationMs: 0 },
        { do: "wait", durationMs: 1400 },
        { do: "click", selector: ".size-options button:nth-of-type(3)", durationMs: 0 },
  ...
  },
  {
    ...
    options: {
      ...
      actions: [
        { do: "hover", selector: "#shop-grid .product:nth-child(4) .product-media", durationMs: 0 },
        { do: "wait", durationMs: 5600 },
        { do: "click", selector: "#shop-grid .product:nth-child(4) .wishlist", durationMs: 0 },
        { do: "wait", durationMs: 1200 },
        { do: "click", selector: "#shop-grid .product:nth-child(4) .wishlist", durationMs: 0 },
        { do: "wait", durationMs: 1200 },
      ],
